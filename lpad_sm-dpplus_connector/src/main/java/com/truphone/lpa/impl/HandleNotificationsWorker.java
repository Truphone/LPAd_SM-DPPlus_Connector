...
import com.truphone.lpa.dto.asn1.rspdefinitions.ListNotificationResponse;
import com.truphone.lpa.dto.asn1.rspdefinitions.NotificationMetadata;
import com.truphone.lpa.dto.asn1.rspdefinitions.NotificationSentResponse;
import com.truphone.lpa.dto.asn1.rspdefinitions.PendingNotification;
import com.truphone.lpa.dto.asn1.rspdefinitions.RetrieveNotificationsListResponse;
...
public class HandleNotificationsWorker {
    ...
    void run(NotificationType notificationType) {
        ...
        try {
            ...
            for (NotificationMetadata notification : list.getNotificationMetadataList().getNotificationMetadata()) {
                ...
                String seqNo = Util.byteToHexString(notification.getSeqNumber().byteValue());
    ...
    private void handlePendingNotification(String seqNo, RetrieveNotificationsListResponse notificationListResponse) throws IOException, DecoderException {
        ...
        if (notificationListResponse != null && notificationListResponse.getNotificationList() != null &&
            ...
            for (PendingNotification pendingNotification : notificationListResponse.getNotificationList().getPendingNotification()) {
                ...
                es9Module.handleNotification(encodedPendingNotification);

                removeNotification(seqNo);
            }
    }

    private RetrieveNotificationsListResponse getRetrieveNotificationsListResponse(String seqNo) throws DecoderException, IOException {
    ...
    private void removeNotification(String seqNo) throws DecoderException, IOException {
