...
import com.truphone.lpa.dto.asn1.rspdefinitions.ProfileInfo;
import com.truphone.lpa.dto.asn1.rspdefinitions.ProfileInfoListResponse;
    ...
    List<Map<String, String>> run() {
        ...
        try {
            ...
            for (ProfileInfo info : profiles.getProfileInfoListOk().getProfileInfo()) {
                ...
                profileMap.put(ProfileKey.NAME.name(), info.getProfileName().toString());
                profileMap.put(ProfileKey.PROVIDER_NAME.name(), info.getServiceProviderName().toString());
