...
public class HttpRSPClient {
    ...
    public HttpResponse clientRSPRequest(String body, String rspServerUrl, String url) throws Exception {
    ...
    public HttpResponse clientSimpleRequest(String body, String rspServerUrl, String url) throws Exception {
    ...
    HttpResponse invoke(final String method,
                        final String body,
